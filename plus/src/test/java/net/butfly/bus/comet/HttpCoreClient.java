...
//
//	/**
//	 * Initialize the client. This method should be called before sending the
//	 * messages.
//	 *
//	 * @throws RuntimeException
//	 *             if the IORector cannot be started
//	 */
...
//	 * 
//	 * @param inputStream
//	 *            input stream with the content of the message
//	 * @param callBack
//	 *            callback to notify the completion, failure and cancellation
//	 * @throws Exception
//	 *             if an error occurs
//	 */
//	public void send(InputStream inputStream, final SendCallBack callBack) throws Exception {
//		// Create HTTP requester
//		HttpAsyncRequester requester = new HttpAsyncRequester(httpproc, new DefaultConnectionReuseStrategy(), params);
...
//			ioReactor.shutdown();
//		} catch (IOException e) {
//			logger.error("Error occurred while shutting down the client..", e);
//			throw e;
//		}
//	}
//
...
//			logger.info("Successfully completed the message");
//		}
//
...
//	}
//
//	private void handleError(String msg, IOReactorException e) throws RuntimeException {
//		logger.error(msg, e);
